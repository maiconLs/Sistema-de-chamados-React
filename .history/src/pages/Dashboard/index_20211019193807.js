...
import { FiMessageSquare, FiPlus, FiSearch, FiEdit2, RiDeleteBin6Line } from 'react-icons/fi';
                  ...
                  return(
                    <tr key={index}>
                      ...
                      <td data-label="#">
                        ...
                        <button className="action" style={{backgroundColor: '#' }} onClick={ () => togglePostModal(item) }>
                          <RiDeleteBin6Line color="#FFF" size={17} />
                        </button>
                      </td>
                    </tr>
                  )
